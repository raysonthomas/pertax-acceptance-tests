...
Feature:
  ...
  Scenario: when a gg user has navigates to the child benefit page they should see the correct links and content
    ...
    And user sees text 'leaves education or training' on the CB page
    And user sees 'leaves education or training' link on the page and its href is as expected
    ...
    And user sees text 'stop or restart your Child Benefit payments' on the CB page
    And user sees 'stop or restart your Child Benefit payments' link on the page and its href is as expected
