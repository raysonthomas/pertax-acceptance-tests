...
Feature: Verify my home address
  ...
  Scenario: User has an effective from date of 6th April 2016 and able to view correct details. User changes home address
    ...
    Then user waits for 'Your address' page
    And user is on the page with title 'Your address' and URL is as expected
    Then user is able to see a section '6 April 2016'
    And user sees 'Change your address' link on the page and its href is as expected
    Then user clicks on 'Change your address' link
    ...
    And user waits to enter start date
    ...
    Then user waits for 'Check your details' page
