...
Feature: Change/Modify my home address
  ...
  Scenario Outline: Negative update address journey
    ...
    And user updates address 'line5' with '<line5_content>'
    ...
    And the error message for address 'line5' is '<line5_error_msg>'
    And the error message for 'postcode' is '<postcode_error_msg>'
    Examples:
      | line1_content   | line2_content   | line3_content   | line4_content             | line5_content             | postcode_content | line1_error_msg                                                                                                                                                              | line2_error_msg                                                                                                                                                              | line3_error_msg                                                                                                                                                              | line4_error_msg                                                                                                                                                              | line5_error_msg                                                                                                                                                              | postcode_error_msg        |
      |                 |                 |                 |                           |                           |                  | This line is required                                                                                                                                                        | This line is required                                                                                                                                                        | None                                                                                                                                                                         | None                                                                                                                                                                         | None                                                                                                                                                                         | Enter a valid UK postcode |
      | £               | ¬               |                 | p                         | ^                         | NE12AB           | Your address can include letters a to z, numbers, spaces, hyphens (-), apostrophes (‘), commas (,), forward slashes (/) , full stops (.), ampersands (&) and round brackets. | Your address can include letters a to z, numbers, spaces, hyphens (-), apostrophes (‘), commas (,), forward slashes (/) , full stops (.), ampersands (&) and round brackets. | This line is required                                                                                                                                                        | Your address can include letters a to z, numbers, spaces, hyphens (-), apostrophes (‘), commas (,), forward slashes (/) , full stops (.), ampersands (&) and round brackets. | Your address can include letters a to z, numbers, spaces, hyphens (-), apostrophes (‘), commas (,), forward slashes (/) , full stops (.), ampersands (&) and round brackets. | None                      |
      | !#$%&’()*+,-./: | ;<=>?@[\]^_‘{}~ | ;<=>?@[\]^_‘{}~ | <script>alert(1)</script> | ;<=>?@[\]^_‘{}~           | NE1 2AB          | Your address can include letters a to z, numbers, spaces, hyphens (-), apostrophes (‘), commas (,), forward slashes (/) , full stops (.), ampersands (&) and round brackets. | Your address can include letters a to z, numbers, spaces, hyphens (-), apostrophes (‘), commas (,), forward slashes (/) , full stops (.), ampersands (&) and round brackets. | Your address can include letters a to z, numbers, spaces, hyphens (-), apostrophes (‘), commas (,), forward slashes (/) , full stops (.), ampersands (&) and round brackets. | Your address can include letters a to z, numbers, spaces, hyphens (-), apostrophes (‘), commas (,), forward slashes (/) , full stops (.), ampersands (&) and round brackets. | Your address can include letters a to z, numbers, spaces, hyphens (-), apostrophes (‘), commas (,), forward slashes (/) , full stops (.), ampersands (&) and round brackets. | None                      |
      | &’(),  -./      | &’(),  -./      | &’(),  -./      | <script>alert(1)</script> | &’(),  -./                | &’(),  -./       | None                                                                                                                                                                         | None                                                                                                                                                                         | None                                                                                                                                                                         | Your address can include letters a to z, numbers, spaces, hyphens (-), apostrophes (‘), commas (,), forward slashes (/) , full stops (.), ampersands (&) and round brackets. | None                                                                                                                                                                         | Enter a valid UK postcode |
      | My 42 Road      | Clean county    |                 | Northumbria               | North East England        | TF34ER           | None                                                                                                                                                                         | None                                                                                                                                                                         | This line is required                                                                                                                                                        | None                                                                                                                                                                         | None                                                                                                                                                                         | None                      |
      | My 43 Road      | Clean county    | Northumbria     |                           | North East England        | TF34ER           | None                                                                                                                                                                         | None                                                                                                                                                                         | None                                                                                                                                                                         | This line is required                                                                                                                                                        | None                                                                                                                                                                         | None                      |
