...
Feature:
  ...
  Scenario: PTA alerts about unused Personal Allowance (User with multiple incomes, one income uses up all Personal Allowance)
    Given 'John Densmore' has a personal allowance of £'10000.00'
    And 'John Densmore' works at 'Asda' Employer Ref: 'ABC' / Payroll ID: '123' as a 'cleaner'
    ...
    And FPS holds data stating that 'Asda' Employer Ref: 'ABC' has assigned 'John Densmore' a tax code of '1000L' on Payroll ID: '123'
    And 'John Densmore' works at 'Asda' Employer Ref: 'ABC' / Payroll ID: '456' as a 'shop floor worker'
    ...
    And FPS holds data stating that 'Asda' Employer Ref: 'ABC' has assigned 'John Densmore' a tax code of 'BR' on Payroll ID: '456'
    And 'John Densmore' works at 'Asda' Employer Ref: 'ABC' / Payroll ID: '789' as a 'security guard'
    ...
    And FPS holds data stating that 'Asda' Employer Ref: 'ABC' has assigned 'John Densmore' a tax code of 'BR' on Payroll ID: '789'
  ...
  Scenario: PTA alerts about unused Personal Allowance (User with pension & multiple incomes, one income uses up all Personal Allowance)
    Given 'John Densmore' has a personal allowance of £'10600.00'
    And 'John Densmore' works at 'Asda' Employer Ref: 'ABC' / Payroll ID: '222' as a 'cleaner'
    ...
    And FPS holds data stating that 'Asda' Employer Ref: 'ABC' has assigned 'John Densmore' a tax code of '1060L' on Payroll ID: '222'
    And 'John Densmore' works at 'Asda' Employer Ref: 'ABC' / Payroll ID: '333' as a 'shop floor worker'
    ...
    And FPS holds data stating that 'Asda' Employer Ref: 'ABC' has assigned 'John Densmore' a tax code of 'BR' on Payroll ID: '333'
    And 'John Densmore' works at 'Asda' Employer Ref: 'ABC' / Payroll ID: '444' as a 'security guard'
