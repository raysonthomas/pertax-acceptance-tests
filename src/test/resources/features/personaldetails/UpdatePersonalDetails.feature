...
Feature: Update Personal Details
  ...
  Examples:
    ...
    |                 |                 |                 |                           |                  | This field is required                                                                                                                      | This field is required                                                                                                                      |                        |                                                                                                                                             | Enter a valid UK postcode |
    ...
    | !#$%&’()*+,-./: | ;<=>?@[\]^_‘{}~ | ;<=>?@[\]^_‘{}~ | <script>alert(1)</script> | NE1 2AB          |                                                                                                                                             |                                                                                                                                             |                        |                                                                                                                                             |                           |
    | My 42 Road      | Clean county    |                 | Northumbria               | TF34ER           |                                                                                                                                             |                                                                                                                                             | This field is required |                                                                                                                                             | Enter a valid UK postcode |
