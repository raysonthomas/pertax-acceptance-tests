...
<<<<<<< HEAD
    "A user who is a trusted helpee"                                  -> UserProperties.build(nino = Some("PJ523813C"), verify = true),  //M Andrew
...
//    "A user who is a trusted helpee"                                  -> UserProperties.build(nino = Some("CE123457D"), verify = true), PJ523813C
    "A user who is a trusted helpee"                                  -> UserProperties.build(nino = Some("PJ523813C"), verify = true),
>>>>>>> 6bd291d00b991fe8f899500dc085c1202b6dc1a6
